...
export default class Touch { // based on example here https://developer.mozilla.org/en/docs/Web/API/Touch_events
	public ongoingTouches: any
	public firstTouch: any
	...
	constructor (input: UserInput) {
		...
		let world = input.world,
			...
			system = this,
			domElement = this.world.three.renderer.domElement

		domElement.addEventListener("touch", (event: any) => this.onTouch( event ), false)
		domElement.addEventListener("touchmove", (event: any) => this.onTouchMove( event ), false)
		domElement.addEventListener("touchstart", (event: any) => this.onTouchStart( event ), false)
		domElement.addEventListener("touchend", (event: any) => this.onTouchEnd( event ), false)
		domElement.addEventListener("touchcancel", (event: any) => this.onTouchCancel( event ), false)
	...
	ongoingTouchIndexById( idToFind: any ) {
