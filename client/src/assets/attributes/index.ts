...
export default function BuiltinProps () {
    return {
        ...
        assets: [ 
            ...
            { path: "/data/images/textures/terrain4.jpg" }, 
            { path: "/data/images/textures/foliage1.jpg" },
            { path: "/data/images/textures/metal5.jpg" }, 
            { path: "/data/images/textures/metal4.jpg" }, 
            { path: "/data/images/textures/metal3.png" },
