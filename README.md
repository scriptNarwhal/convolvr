...
```
## Server Examples
- [Generating Buildings](https://github.com/convolvr/generate/blob/dev/server/generated-buildings.go)
- [Handling User Actions](https://github.com/convolvr/server/blob/dev/server/socket.go#L17)
