...
func generateWheel(id int, world string, x int, z int, altitude float32) *Entity {
	var (
		structure           *Entity
	...
	structure = NewEntity(id+1, "Wheel", world, []int{x, 0, z}, structureComponents, structurePos, []float64{0.0, 0.0, 0.0, 0.0}, structureRadius, nil)
	return structure
}

func canPlaceWheelAt(x int, y int, z int) bool {
